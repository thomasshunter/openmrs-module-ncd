...
public class PersonName extends HL7NameHandler {
	...
	static {		
		FAMILY_NAME_EXPRESSION = "./PN.1/FN.1/text()";
		FAMILY_NAME_ALT_EXPRESSION = "./PN.1/text()";
		GIVEN_NAME_EXPRESSION = "./PN.2/text()";
		MIDDLE_NAME_EXPRESSION = "./PN.3/text()";
		SUFFIX_NAME_EXPRESSION = "./CN.4/text()";
		PREFIX_NAME_EXPRESSION = "./CN.5/text()";
		DEGREE_NAME_EXPRESSION = "./CN.6/text()";
	}
