...
/**
 * The archived version of a cached result from critic processing of a
 * candidate result, along with the matching information to compare
 * against future candidate results to determine if it can be reused.
 * 
 ...
 */
public class DecidedResultArchive implements java.io.Serializable, ListPageRow {
    ...
    public DecidedResultArchive() {
    }

    public DecidedResultArchive(DecidedResult toClone)
    {
        if (toClone != null) {
