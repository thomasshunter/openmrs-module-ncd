 ...
 *
 */
public class CompositeName extends HL7NameHandler {
	...
	static {
		IDENTIFIER_EXPRESSION = "./CN.1/text()";
		FAMILY_NAME_EXPRESSION = "./CN.2/text()";
		GIVEN_NAME_EXPRESSION = "./CN.3/text()";
		MIDDLE_NAME_EXPRESSION = "./CN.4/text()";
		SUFFIX_NAME_EXPRESSION = "./CN.5/text()";
		PREFIX_NAME_EXPRESSION = "./CN.6/text()";
		DEGREE_NAME_EXPRESSION = "./CN.7/text()";
	}
	...
	public String getFamilyName(Node node) {
		return XmlUtilities.findFieldValue(FAMILY_NAME_EXPRESSION, node);		
	}
