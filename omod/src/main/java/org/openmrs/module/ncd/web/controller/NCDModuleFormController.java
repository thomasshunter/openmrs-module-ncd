...
/**
 * This class configured as controller using annotation and mapped with the URL of 'module/ncd/ncdLink.form'.
 */
@Controller
@RequestMapping(value = "module/ncd/ncdLink.form")
public class NCDModuleFormController {
	
	/** Logger for this class and subclasses */
	protected final Log log = LogFactory.getLog(getClass());
	
	/** Success form view name */
	private final String SUCCESS_FORM_VIEW = "/module/ncd/ncdForm";
